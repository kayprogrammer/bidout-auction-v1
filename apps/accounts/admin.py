...
admin.site.site_header = mark_safe('<strong style="font-weight:bold;">B.A. V1 ADMIN</strong>')
...
class UserAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None,
            {
                "classes": ("wide",),
                "fields": ("first_name", "last_name", "email", "tz", "password1", "password2", "is_staff", "is_active"),
            }
        ),
    )
